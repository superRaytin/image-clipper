...
1. Since server-side Node.js doesn't natively support Canvas, so you must to specify a Canvas implementation library, such as [node-canvas](https://github.com/Automattic/node-canvas). [See usage](#clipperinjectnodecanvascanvas)
